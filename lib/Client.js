				...
				if(id.startsWith("homey.")) {
					try {
						...
						Object.keys(compoundCapabilities).forEach(key => {
							...
							// if (unit_of_measurement != null){
							// 	capabilitiesOptions[key]["units"] = entity.attributes.unit_of_measurement;
							// }

							// Dynamic capability icons are not possible :(
							// if(compoundCapabilitiesIcons[key] != null) {
							// 	let icon = compoundCapabilitiesIcons[key];
							// 	if (icon.startsWith("mdi:")){
							// 		icon = "../../../assets/icons/mdi/"+icon.split(":")[1]+".svg";
							// 	}
							// 	else
							// 	{
							// 		icon = "../../../assets/icons/capabilities/"+icon+".svg";
							// 	}
							// 	if (capabilitiesOptions[key] == null){
							// 		capabilitiesOptions[key] = {};
							// 	}
							// 	capabilitiesOptions[key]["icon"] = icon;
							// }	
						});
